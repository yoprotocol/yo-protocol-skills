...
| [`yo-mcp`](skills/yo-mcp/SKILL.md)                       | Base MCP plugin for YO Protocol — drives the YO CLI / HTTP API and routes unsigned Gateway calldata through `send_calls`          |
...
npx skills add yoprotocol/yo-protocol-skills --skill yo-mcp
